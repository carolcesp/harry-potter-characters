    ...
    const filterResult = this.filterCharacters();
      return (
        <div className="App">
          ...
          <input  type="text" size="30" placeholder="Busca a tu personaje favorito" onKeyUp={this.getField}></input>
